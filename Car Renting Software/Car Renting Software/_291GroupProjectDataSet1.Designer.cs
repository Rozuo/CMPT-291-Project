...
namespace Car_Renting_Software {
    ...
    public partial class _291GroupProjectDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CarDataTable : global::System.Data.TypedTableBase<CarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CarRow AddCarRow(int VehicleID, string Type_of_Vehicle, string Color, string Make, string Brand, int CustomerID) {
...
namespace Car_Renting_Software._291GroupProjectDataSet1TableAdapters {
    ...
    public partial class CarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Car] ([VehicleID], [Type of Vehicle], [Color], [Make], [Brand], [CustomerID]) VALUES (@VehicleID, @Type_of_Vehicle, @Color, @Make, @Brand, @CustomerID);
SELECT VehicleID, [Type of Vehicle], Color, Make, Brand, CustomerID FROM Car WHERE (VehicleID = @VehicleID)";
...
SELECT VehicleID, [Type of Vehicle], Color, Make, Brand, CustomerID FROM Car WHERE (VehicleID = @VehicleID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT VehicleID, [Type of Vehicle], Color, Make, Brand, CustomerID FROM dbo.Car";
        ...
        public virtual int Delete(int Original_VehicleID, string Original_Type_of_Vehicle, string Original_Color, string Original_Make, string Original_Brand, int Original_CustomerID) {
        ...
        public virtual int Insert(int VehicleID, string Type_of_Vehicle, string Color, string Make, string Brand, int CustomerID) {
        ...
        public virtual int Update(int VehicleID, string Type_of_Vehicle, string Color, string Make, string Brand, int CustomerID, int Original_VehicleID, string Original_Type_of_Vehicle, string Original_Color, string Original_Make, string Original_Brand, int Original_CustomerID) {
            ...
            if ((Original_Type_of_Vehicle == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Type_of_Vehicle));
            }
            if ((Original_Color == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Type_of_Vehicle, string Color, string Make, string Brand, int CustomerID, int Original_VehicleID, string Original_Type_of_Vehicle, string Original_Color, string Original_Make, string Original_Brand, int Original_CustomerID) {
            return this.Update(Original_VehicleID, Type_of_Vehicle, Color, Make, Brand, CustomerID, Original_VehicleID, Original_Type_of_Vehicle, Original_Color, Original_Make, Original_Brand, Original_CustomerID);
        }
    }
